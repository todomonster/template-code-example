        ...
        if (this.options.onBeforeHighlight(range) === true) {
            ...
            if (modal) {
                modal.onclick = () => {
                    ...
                    //執行掛載class array of created highlights.
                    ...
                    // 提取Range信息并保存为普通JavaScript对象
                    const rangeInfo = {
                        startContainerHTML: range1.startContainer.outerHTML,
                        startOffset: range1.startOffset,
                        endContainerHTML: range1.endContainer.outerHTML,
                        endOffset: range1.endOffset,
                        // 其他标记相关信息，例如颜色等
                    };

                    // 将提取的信息保存到localStorage中
                    localStorage.setItem("highlightedRangeInfo", JSON.stringify(rangeInfo));
